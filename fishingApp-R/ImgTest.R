urlF <-  paste("http://www.nifs.go.kr/frcenter/species/?curPage=12&order=asc&mf_psc_cd=&new_input=no&keyword=&mf_l_cls_cd=&mf_m_cls_cd=&mf_s_cls_cd=&mf_dogam_id=&sort_by=mf_kor_name", sep="")
url_dataF <- readLines(urlF, encoding = "UTF-8")
url_dataF

#### 데이터 필터링: species_image ####
